...
class Product
{
    ...
    function set_base_price($product_id, $price)
    {
        return update_post_meta($product_id, '_price', $price);
    }

    function set_gumroad_short_url($product_id, $url)
    {
        return update_post_meta($product_id, 'gumroad_product_url', $url);
    }

    function ul_set_product_featured_image($post_id, $image_name, $image_url)
    {
        $image_name .= '.jpg';
